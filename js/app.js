(function () {
  ...
  // (não exigido pela licença deles, mas recomendado). Processador, Sous Vide (Equipamento) e
  // o ícone da aba Preparos são autorais (confirmado com o usuário) — sem fonte externa a
  // creditar, não entram nesta lista. Fica em Minhas Receitas por ora — não há rodapé fixo no
  // app pra isso ainda.
