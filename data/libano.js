...
window.RECIPES["libano"] = [
  ...
  // ===================== PASTAS E MOLHOS =====================
  {
    ...
    ingredients: [
      ...
      "Suco de 1-2 limões",
      "2 dentes de alho",
      "3 colheres (sopa) de azeite de oliva (+ extra para servir)",
      "1 colher (chá) de cominho",
      "Água gelada ou o líquido do grão-de-bico, para ajustar a textura",
    ...
    steps: [
      ...
      "Com o processador ligado, adicione água gelada (ou o líquido do grão-de-bico) aos poucos, até atingir uma consistência bem lisa e cremosa.",
      "Adicione o azeite e bata mais um pouco, até incorporar.",
      "Prove e ajuste sal, limão e alho a gosto.",
      "Sirva num prato raso, espalhando com o dorso de uma colher formando ondas, regado com azeite extra, páprica e salsinha por cima."
    ],
    tips: [
      "Retirar a pele do grão-de-bico é um passo trabalhoso mas que faz diferença real na textura final — é o que diferencia um hommus caseiro comum de um extremamente aveludado.",
      "Bater por bastante tempo (vários minutos) incorporando ar é o que dá a textura cremosa característica — não tenha pressa nessa etapa.",
      "Água gelada (em vez de temperatura ambiente) ajuda a emulsionar melhor e deixa o hommus mais claro e fofo."
    ]
  },
  {
    name: "Babaganuche",
    ...
    steps: [
      ...
      "Transfira para uma tigela coberta (ou saco plástico) por 10 minutos — o vapor ajuda a soltar a pele.",
      "Corte as berinjelas ao meio e retire a polpa com uma colher, descartando a pele. Deixe escorrer num coador por 10 minutos, para remover o excesso de líquido amargo.",
      "Pique ou amasse a polpa levemente com um garfo (a textura tradicional é rústica, não completamente lisa).",
      "Misture com o tahine, suco de limão, alho e azeite, temperando com sal.",
      "Sirva num prato raso, regado com mais azeite, salsinha picada e sementes de romã, se disponível."
    ],
    tips: [
      "Assar diretamente na chama do fogão (quando possível) dá um sabor defumado autêntico que o forno sozinho não replica — vale a pena, se tiver fogão a gás.",
      "Escorrer a polpa depois de assada remove o amargor residual e o excesso de líquido que deixaria a pasta aguada.",
      "Diferente do hommus, o babaganuche deve manter uma textura levemente rústica — não bata no processador até ficar completamente liso."
    ]
  },
  ...
  // ===================== CARNES =====================
  {
    ...
    ingredients: [
      ...
      "1/2 cebola ralada",
      "1 pitada de pimenta síria (ou mistura de especiarias: pimenta-da-jamaica, canela, cominho)",
      "Sal a gosto",
    ...
    steps: [
      ...
      "Junte o trigo bem escorrido, amassando e sovando a mistura com as mãos por vários minutos, até formar uma massa homogênea e coesa (deve ficar lisa e ligeiramente elástica).",
      "Tempere com sal a gosto durante o processo de sova.",
      "Modele em formato de disco achatado numa travessa, alisando a superfície com as mãos molhadas em água gelada.",
      "Faça marcas decorativas com uma faca (losangos ou linhas), regue generosamente com azeite de oliva.",
      "Sirva imediatamente, gelado, decorado com hortelã fresca e cebola fatiada."
    ],
    tips: [
      "Use sempre carne de procedência confiável e bem fresca, moída na hora se possível — é consumida crua, então a qualidade e higiene são fundamentais.",
      "Sovar bem a mistura de carne e trigo é o que dá a textura coesa e lisa característica — não pule essa etapa achando que é só misturar.",
      "Trabalhe com as mãos e utensílios sempre gelados, e mantenha o quibe na geladeira até o momento de servir."
    ]
  },
  {
    name: "Quibe Frito",
    ...
    steps: [
      ...
      "Adicione o pinoli e a pimenta síria, misturando bem. Deixe esfriar completamente.",
      "Prepare a casca como no Quibe Cru: misture a carne moída, trigo hidratado e escorrido, cebola ralada e temperos, sovando bem até formar uma massa lisa e coesa.",
      "Com as mãos molhadas, pegue uma porção da massa da casca (do tamanho de um ovo) e molde uma bola.",
      "Com o dedo indicador, faça um buraco no centro da bola, girando e afinando as paredes até formar um formato oval oco, como uma casca fina.",
      "Preencha com uma colher do recheio de carne com pinoli, e feche a abertura, moldando as pontas para formar o formato clássico de charuto/torpedo.",
      "Aqueça o óleo numa panela funda a 170-180°C.",
      "Frite os quibes em lotes, até dourarem bem por igual, 4-5 minutos.",
      "Escorra em papel toalha e sirva quente."
    ],
    tips: [
      "Moldar a casca fina e uniforme é a parte mais desafiadora da receita — pratique com as mãos bem molhadas, que evita que a massa grude e rache.",
      "O recheio deve estar completamente frio antes de rechear a casca crua — recheio quente pode amolecer e romper a casca ao moldar.",
      "Pode ser assado no forno (a 200°C por 20-25 minutos, virando na metade) como alternativa mais leve à fritura."
    ]
  },
  {
    name: "Kafta",
    ...
    steps: [
      ...
      "Sove bem a mistura com as mãos por alguns minutos, até ficar homogênea e levemente pegajosa (isso ajuda a segurar no espeto sem esfarelar).",
      "Leve à geladeira por 30 minutos, para firmar.",
      "Com as mãos molhadas, molde porções da carne ao redor dos espetos, formando cilindros alongados e compactos.",
      "Aqueça bem a churrasqueira ou grelha em fogo alto.",
      "Grelhe os espetos por 3-4 minutos de cada lado, virando com cuidado, até dourarem bem por fora e cozinharem por dentro.",
      "Sirva com pão pita, salada e molho de tahine ou toum (molho de alho libanês)."
    ],
    tips: [
      "Escorrer bem a cebola ralada (espremendo o excesso de líquido) é importante — cebola muito úmida deixa a mistura de carne mole demais para moldar bem no espeto.",
      "Sovar bem a carne desenvolve uma leve liga proteica que ajuda a manter o formato no espeto durante o cozimento, sem esfarelar.",
      "Pode ser moldado em formato de hambúrguer achatado também, para grelhar numa frigideira ou chapa, sem necessidade de espetos."
    ]
  },
  ...
  // ===================== SALADAS E PÃES =====================
  {
    ...
    ingredients: [
      ...
      "1 maço pequeno de hortelã, picada bem fina",
      "3 tomates maduros, picados em cubos pequenos, sem sementes",
    ...
    steps: [
      ...
      "Junte o tomate picado e a cebola.",
      "Adicione o trigo escorrido, misturando delicadamente.",
      "Tempere com suco de limão, azeite e sal, misturando bem.",
      "Deixe descansar na geladeira por 15-20 minutos antes de servir, para os sabores se assentarem.",
      "Sirva frio ou em temperatura ambiente, com folhas de alface ou pão pita para acompanhar."
    ],
    tips: [
      "A proporção tradicional libanesa é predominantemente ervas frescas com uma pequena quantidade de trigo — muitas versões ocidentais invertem essa proporção, o que descaracteriza o prato.",
      "Picar a salsinha e a hortelã bem fino (quase como uma chiffonade fina) é essencial para a textura correta da salada.",
      "Retirar as sementes do tomate evita que a salada fique aguada — um passo simples mas importante."
    ]
  },
  {
    name: "Fattoush",
    ...
    steps: [
      ...
      "Prepare o molho misturando o suco de limão, azeite, melaço de romã (se usar), alho picado e sal.",
      "Regue a salada com o molho só na hora de servir, misturando bem.",
      "Adicione os pedaços de pão crocante por cima, misturando delicadamente para não amolecerem completamente.",
      "Sirva imediatamente, enquanto o pão ainda está crocante."
    ],
    tips: [
      "Adicione o pão só na hora de servir — se misturado com antecedência, absorve o molho e perde toda a crocância característica.",
      "O sumac (especiaria árabe de sabor cítrico) é tradicional no tempero, mas o limão sozinho já dá uma boa acidez se não encontrar o ingrediente.",
      "Uma ótima forma de aproveitar pão pita que ficou um pouco dormido/duro — a torrada final resolve a textura."
    ]
  },
  {
    name: "Esfiha",
    ...
    steps: [
      ...
      "Prepare o recheio: misture a carne moída crua com tomate, cebola, limão, azeite, hortelã e pimenta síria, temperando com sal. A mistura deve ficar bem temperada e úmida.",
      "Divida a massa em porções pequenas (bolinhas de cerca de 40g), abra cada uma num disco fino de cerca de 10 cm.",
      "Coloque uma colher do recheio de carne no centro de cada disco.",
      "Dobre as bordas para dentro, formando um formato de losango ou triângulo aberto, deixando o recheio parcialmente exposto no centro (a esfiha aberta é o formato clássico, diferente do formato fechado que lembra um pastel).",
      "Disponha numa assadeira e deixe descansar por 10 minutos.",
      "Asse em forno bem quente (220-230°C) por 10-12 minutos, até a massa dourar e a carne cozinhar."
    ],
    tips: [
      "A esfiha aberta (com o recheio de carne crua exposto, que cozinha no calor do forno) é o formato tradicional levantino — diferente da esfiha fechada, mais comum e adaptada no Brasil.",
      "O recheio deve estar bem temperado e com um pouco de acidez do limão — a carne cozinha rapidamente no forno quente, então precisa já estar saborosa quando crua.",
      "Um forno bem quente é essencial para que a massa asse rápido o suficiente sem ressecar antes da carne cozinhar por completo."
    ]
  },
];
